...
<main class="workspace-surface">
    ...
    <div class="toolbar border-bottom">
        <div>
            <h1 class="fs-5 fw-semibold m-0 text-dark">Gardening Schedules</h1>
            <p class="text-muted mb-0" style="font-size: 0.75rem;">Coordinate planting seasons, maintenance checklists,
                and inspections across your properties</p>
        </div>
    ...
    <div class="workspace-scroll">
        <div class="row g-4">
            ...
            <!-- Right: Interactive mini instructions -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content drive-modal-content">
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-semibold text-dark">Schedule New Gardening Task</h5>
                ...
                <form id="addTaskForm">
                    <div class="mb-3">
                        <label for="title" class="form-label text-secondary"
                            style="font-size: 0.75rem; font-weight:600;">TASK SUMMARY</label>
                        <input type="text" class="form-control drive-form-control w-100" id="title" name="title"
                            required placeholder="e.g. Irrigation Check">
                    </div>

                    <div class="mb-3">
                        <label for="task_type" class="form-label text-secondary"
                            style="font-size: 0.75rem; font-weight:600;">TASK TYPE</label>
                        <select class="form-select drive-form-control w-100" id="task_type" name="task_type" required>
                            ...
                            <option value="planting">Planting / Composting</option>
                            <option value="weeding">Weeding / Pruning</option>
                            <option value="other">Other / Site Visit</option>
                        </select>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="start_time" class="form-label text-secondary"
                                style="font-size: 0.75rem; font-weight:600;">START DATE & TIME</label>
                        ...
                        <div class="col-md-6">
                            <label for="end_time" class="form-label text-secondary"
                                style="font-size: 0.75rem; font-weight:600;">END DATE & TIME</label>
                    ...
                    <div class="mb-4">
                        <label for="description" class="form-label text-secondary"
                            style="font-size: 0.75rem; font-weight:600;">DETAILED INSTRUCTIONS</label>
                        <textarea class="form-control drive-form-control w-100" id="description" name="description"
                            rows="3" placeholder="Provide task list or instructions..."></textarea>
                    </div>

                    <div class="d-flex justify-content-end gap-2">
                        <button type="button" class="btn btn-drive-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-drive-primary">Schedule Task</button>
                    </div>
                </form>
            </div>
        </div>
